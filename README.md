...
- If you extract the .jar files, they will not show all classes, for some reason it will show only screen.class and v1.class
  [this section is subject to change, if it fixes itself or if I fix it]

  
THIS GAME USES THE 3-CLAUSE BSD LICENSE.
===